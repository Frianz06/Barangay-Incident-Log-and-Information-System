<?php include '../includes/headers/header_admin_resolve.php';
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            ...
            <div class="card text-bg-dark p-2" style="width: 30rem;">
                ...
                <div class="card-header card-title text-center"><h3>Submit Archive Details</h3></div>

                <div class="card-body">
                    <form method="POST">
                        <?php include 'admin_archive_form.php'?>
                        ...
                        <div class="mb-3">
                            <label for="archive_description" class="form-label"><strong>Archive Description:</strong></label>
                            <textarea name="archive_description" id="area" class="form-control" rows="3"  required></textarea>
                        </div>
        

                        <div class="d-grid">
                            <button type="submit" class="btn btn-danger">Mark Incident as Archived / Unsolved</button>
                        </div>
